package eseo.techerguillaume.android.data.service;

/**
 * Created by techergu on 09/01/2019.
 */
import eseo.techerguillaume.android.BuildConfig;
...
public interface ApiService {
    ...
    @GET("/status/list")
    Call<List<LedStatus>> listStatus();
